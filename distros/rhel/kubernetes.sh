...
# Configure Kubernetes yum/dnf repository for a given MAJOR.MINOR version.
# Usage: _configure_k8s_yum_repo <version>
_configure_k8s_yum_repo() {
    local ver="$1"
...
setup_kubernetes_rhel() {
    ...
    _configure_k8s_yum_repo "$K8S_VERSION"
